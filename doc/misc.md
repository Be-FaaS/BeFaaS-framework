...
curl --header "Content-Type: application/json" --header "X-Context: 123789456" --header "X-Pair: 555-456" --request POST --data '{"body":{"title": "Herr ringe", "author":"Blabla", "duration":4500}}' https://ov41n3219b.execute-api.eu-central-1.amazonaws.com/dev/addVideo
```
