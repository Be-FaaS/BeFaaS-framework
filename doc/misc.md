...
curl --header "Content-Type: application/json" --header "X-Context: 123789456" --header "X-Pair: 555-456" --request POST --data '{"deviceid": "dsadsa", "username":"Blabla", "password":4500}' http://141.23.28.204:60010/authDevice

curl --header "Content-Type: application/json" --header "X-Context: 123456785" --header "X-Pair: 545-456" --request POST --data '{"deviceid": "811069503", "username":"sbrattellrp", "password":"iF7HkVvx8f"}' http://141.23.28.204:60010/authDevice

curl --header "Content-Type: application/json" --header "X-Context: 123456785" --header "X-Pair: 545-456" --request POST --data '{"deviceid": "4624139607", "username":"jwalsh1", "password":"qo71qj"}' http://141.23.28.204:60010/authDevice
